...
public class Simr {
    ...
    static class UrlCores {
        public String url;
        public int cores;

        public UrlCores(String _url, int _cores) {
            this.url = _url;
            this.cores = _cores;
        }
    }
    ...
    public static class MyMapper
        ...
        public void startMaster(Configuration conf) {
        ...
        public void startWorker(Configuration conf, FileSystem fs, Context context) throws IOException {
            UrlCores uc = getMasterURL(conf, fs);
            if (uc == null)
                return;
        ...
        public UrlCores getMasterURL(Configuration conf, FileSystem fs) throws IOException {
            ...
            if (gotDriverUrl)
                return new UrlCores(mUrl, maxCores);
            else
                return null;
        }
